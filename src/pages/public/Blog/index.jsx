...
moment.locale('es');
function Blog({ setIsOpen, isPrivate, isPrivateNews }) {
    ...
    <div id='blogIndex'>
      {blogPage && Object.keys(blogPage).length > 0 ? (
        <div>
                      ...
                      <div className={stylesBlog.apis__library}>
                        ...
                        <div id='Suggestions' className={`d-xs-none ${stylesBlog.apis__library__suggestions}`}>
                          <div className={stylesBlog.apis__library__suggestions__content}>
                            <h1 className={`${stylesBlog.apis__library__suggestions__content__title} fs__16 text-uppercase text__tertiary mt-4`}>{t('Blog.recent')}</h1>
          ...
          {isPrivateNews && (
            <section
              className={`${classes.section__news} ${classes.section__news_toppadding} d-xs-none ${!isPrivateNews ? 'mt-10' : ''}`}
            >
              ...
              <div className='container'>
                <div className='row'>
                  <div className={`flex-md-12 flex-sm-12 ${classes.section__news__title}`}>
                    <h1
                      className='h2 text__dark__primary'
                      style={isPrivateNews ? { color: '#160A68' } : {}}
                    >
                      {isPrivateNews ? t('Blog.ourExperiences') : t('Blog.youMayAlsoLike')}
                    </h1>
                  ...
                  <div className='row justify-center'>
                    <div className='flex-lg-2 flex-md-6 flex-sm-12 text-center'>
                      <HashLink smooth to='/blog#blogIndex'>
                        <div className='link__tertiary'>{t('Blog.seeMore')}</div>
                      </HashLink>
                    </div>
                  </div>
                </div>
