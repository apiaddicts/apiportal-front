...
const config = {
  ...
  topApps: process.env.REACT_APP_LIST_APPS,
  topSubscriptions: process.env.REACT_APP_LIST_SUBSCRIPTIONS,
  topGroup: process.env.REACT_APP_LIST_GROUP_TOP,
  topUser: process.env.REACT_APP_LIST_USER_TOP,
  ...
  policyPath: process.env.REACT_APP_COOKIES_POLICY_PATH,
