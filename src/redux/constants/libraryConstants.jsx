const libraryConstants = {
  ...
  GET_APIS_UNSECURE_REQUEST: 'GET_APIS_UNSECURE_REQUEST',
  GET_APIS_UNSECURE_SUCCESS: 'GET_APIS_UNSECURE_SUCCESS',
  GET_APIS_UNSECURE_FAILURE: 'GET_APIS_UNSECURE_FAILURE',
  ...
  GET_KONG_APIS_REQUEST: 'GET_KONG_APIS_REQUEST',
  GET_KONG_APIS_SUCCESS: 'GET_KONG_APIS_SUCCESS',
  GET_KONG_APIS_FAILURE: 'GET_KONG_APIS_FAILURE',

  GET_AWS_APIS_REQUEST: 'GET_AWS_APIS_REQUEST',
  GET_AWS_APIS_SUCCESS: 'GET_AWS_APIS_SUCCESS',
  GET_AWS_APIS_FAILURE: 'GET_AWS_APIS_FAILURE',
